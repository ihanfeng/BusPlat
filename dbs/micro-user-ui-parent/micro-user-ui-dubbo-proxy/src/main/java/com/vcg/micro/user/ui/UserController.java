...
public class UserController {
    ...
    public User selectByPrimaryKey(@PathVariable("id") Integer id) {
        ...
        return restTemplate.postForObject("http://localhost:10001/defaultGroup/0.0.0/com.vcg.micro.user.service.UserService/selectByPrimaryKey/",httpEntity,User.class);
    }
    ...
    public String delete(@PathVariable("id") Integer id) {
        ...
        return restTemplate.postForObject("http://localhost:10001/defaultGroup/0.0.0/com.vcg.micro.user.service.UserService/deleteByPrimaryKey/",httpEntity,String.class);
    }
    ...
    public String insert(@RequestBody User user) {
        ...
        HttpEntity<List> httpEntity = new HttpEntity<List>(Arrays.asList(map), headers);
        //可以不使用localhost直接访问,可以使用eureka服务发现  application name  进行访问 dubbo-rpc-proxy,
        return loadBalancedRestTemplate.postForObject("http://dubbo-rpc-proxy/defaultGroup/0.0.0/com.vcg.micro.user.service.UserService/insert/",httpEntity,String.class);
    }
}
