...
// *
// */
//public class DecryptRequestDataWrapper extends HttpServletRequestWrapper {
//
//
//  private final String requestData;
//
//
//  public DecryptRequestDataWrapper( HttpServletRequest request ) throws Exception {
//
//    super( request );
//
...
//
//	LoggerFactory.getLogger("searcher.request.access").info("accessinfo:"+clientIP+";"+method+";"+uri+";"+data+";"+request.getRequestURI());
//
...
////		if(passSign){
////			// 验签通过
////			String aeskey = RSA.decrypt(req.encrykey,
////						serverPrivateKey);
