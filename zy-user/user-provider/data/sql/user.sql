...
CREATE TABLE `zy_user_2` (
  ...
  `platform_id` smallint  NOT NULL DEFAULT '0' COMMENT '平台ID(1=PC,2=Wap,3=Android,4=iOS)',
...
CREATE TABLE `zy_user_social` (
  ...
  `platform_id` smallint  NOT NULL DEFAULT '0' COMMENT '平台ID(1=PC,2=Wap,3=Android,4=iOS)',
  `channel_id` smallint  NOT NULL DEFAULT '0' COMMENT '渠道ID(1=QQ,2=SinaWeibo,3=Weixin)',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  `del_status` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
