package com.zhiyin.lbs.util;

/**
 *
 * https://github.com/taoweiji2008/JZLocationConverter-for-Android
 */
public class JZLocationConverter {
  ...
  public static LatLng wgs84ToGcj02(LatLng location) {
    ...
    public static LatLng wgs84ToGcj02(double longitude,double latitude) {
        JZLocationConverter.LatLng location = new JZLocationConverter.LatLng(latitude,longitude);
        return wgs84ToGcj02(location);
    }
  ...
  public static LatLng gcj02ToWgs84(LatLng location) {
    ...
    public static LatLng gcj02ToWgs84(double longitude,double latitude) {
        JZLocationConverter.LatLng location = new JZLocationConverter.LatLng(latitude,longitude);
        return gcj02ToWgs84(location);
    }
  ...
  public static LatLng wgs84ToBd09(LatLng location) {
    ...
    public static LatLng wgs84ToBd09(double longitude,double latitude) {
        JZLocationConverter.LatLng location = new JZLocationConverter.LatLng(latitude,longitude);
        return  wgs84ToBd09(location);
    }
  ...
  public static LatLng gcj02ToBd09(LatLng location) {
    ...
    public static LatLng gcj02ToBd09(double longitude,double latitude) {
        JZLocationConverter.LatLng location = new JZLocationConverter.LatLng(latitude,longitude);
        return gcj02ToBd09(location);
    }
  ...
  public static LatLng bd09ToGcj02(double longitude, double latitude) {
      JZLocationConverter.LatLng location = new JZLocationConverter.LatLng(latitude,longitude);
      return bd09ToGcj02(location);
  }
  ...
  public static LatLng bd09ToWgs84(LatLng location) {
    ...
    public static LatLng bd09ToWgs84(double longitude, double latitude) {
        JZLocationConverter.LatLng location = new JZLocationConverter.LatLng(latitude,longitude);
        return bd09ToWgs84(location);
    }
