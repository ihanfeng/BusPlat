 ...
 * @Description: Servlet
 * API中提供了一个request对象的Decorator设计模式的默认实现类HttpServletRequestWrapper
 * ,
 ...
 * 所以当需要增强request对象时
 * ，只需要写一个类继承HttpServletRequestWrapper类，然后在重写需要增强的方法即可
 * @author: 孤傲苍狼
 * @date: 2014-9-2 下午10:42:57 1.实现与被增强对象相同的接口 2、定义一个变量记住被增强对象 3、定义一个构造函数，接收被增强对象
